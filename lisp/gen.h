...
*type_9 = parse_and_evaluate("[(map type [\"any\"]) (map type [\"numeric\"]) (map type [\"list\"])]");
...
*type_16 = parse_and_evaluate("[(map type [\"callable\"]) (map type [\"list\" \"*\"])]");
BUILTINS_TYPES["map"] = type_16;
auto type_17 = new LispVar;
*type_17 = parse_and_evaluate("[(map type [\"callable\"]) (map type [\"any\"]) (map type [\"list\"])]");
...
BUILTINS_TYPES["closure"] = type_21;
auto type_22 = new LispVar;
*type_22 = parse_and_evaluate("[(map type [\"string\"]) (map type [\"string\"])]");
BUILTINS_TYPES["match"] = type_22;
