...
*type_1 = parse_and_evaluate("[(map type [\"numeric\"])]");
...
*type_21 = parse_and_evaluate("[(map type [\"string\"])]");
BUILTINS_TYPES["type"] = type_21;
auto type_22 = new LispVar;
*type_22 = parse_and_evaluate("[(map type [\"*\" \"list\"])]");
BUILTINS_TYPES["join"] = type_22;
auto type_23 = new LispVar;
*type_23 = parse_and_evaluate("[(map type [\"numeric\"])]");
BUILTINS_TYPES["neg"] = type_23;
auto type_24 = new LispVar;
*type_24 = parse_and_evaluate("[(map type [\"numeric\"])]");
BUILTINS_TYPES["flip"] = type_24;
auto type_25 = new LispVar;
*type_25 = parse_and_evaluate("[(map type [\"numeric\"]) (map type [\"numeric\"])]");
BUILTINS_TYPES["mod"] = type_25;
auto type_26 = new LispVar;
*type_26 = parse_and_evaluate("[(map type [\"numeric\"]) (map type [\"numeric\"])]");
BUILTINS_TYPES["sub"] = type_26;
auto type_27 = new LispVar;
*type_27 = parse_and_evaluate("[(map type [\"numeric\"]) (map type [\"numeric\"])]");
BUILTINS_TYPES["div"] = type_27;
auto type_28 = new LispVar;
*type_28 = parse_and_evaluate("[(map type [\"numeric\" \"?\"]) (map type [\"numeric\" \"?\"]) (map type [\"numeric\" \"?\" \"truthy\"])]");
BUILTINS_TYPES["range"] = type_28;
auto type_29 = new LispVar;
*type_29 = parse_and_evaluate("[(map type [\"any\"]) (map type [\"numeric\"]) (map type [\"list\"])]");
BUILTINS_TYPES["insert"] = type_29;
auto type_30 = new LispVar;
*type_30 = parse_and_evaluate("[(map type [\"booly\"]) (map type [\"string\" \"?\"])]");
BUILTINS_TYPES["assert"] = type_30;
auto type_31 = new LispVar;
*type_31 = parse_and_evaluate("[(map type [\"booly\"])]");
BUILTINS_TYPES["bool"] = type_31;
auto type_32 = new LispVar;
*type_32 = parse_and_evaluate("[(map type [\"list\"]) (map type [\"numeric\"]) (map type [\"numeric\" \"?\"]) (map type [\"numeric\" \"?\" \"truthy\"])]");
BUILTINS_TYPES["slice"] = type_32;
auto type_33 = new LispVar;
*type_33 = parse_and_evaluate("[(map type [\"numeric\"]) (map type [\"any\"])]");
BUILTINS_TYPES["repeat"] = type_33;
auto type_34 = new LispVar;
*type_34 = parse_and_evaluate("[(map type [\"numeric\"]) (map type [\"list\"])]");
BUILTINS_TYPES["get"] = type_34;
auto type_35 = new LispVar;
*type_35 = parse_and_evaluate("[(map type [\"list\"]) (map type [\"list\"])]");
BUILTINS_TYPES["typematch"] = type_35;
auto type_36 = new LispVar;
*type_36 = parse_and_evaluate("[(map type [\"callable\"]) (map type [\"list\" \"*\"])]");
BUILTINS_TYPES["map"] = type_36;
auto type_37 = new LispVar;
*type_37 = parse_and_evaluate("[(map type [\"callable\"]) (map type [\"any\"]) (map type [\"list\"])]");
BUILTINS_TYPES["fold"] = type_37;
auto type_38 = new LispVar;
*type_38 = parse_and_evaluate("[(map type [\"booly\"]) (map type [\"any\"]) (map type [\"any\"])]");
BUILTINS_TYPES["ternary"] = type_38;
auto type_39 = new LispVar;
*type_39 = parse_and_evaluate("[(map type [\"string\"]) (map type [\"any\"])]");
BUILTINS_TYPES["let"] = type_39;
auto type_40 = new LispVar;
*type_40 = parse_and_evaluate("[(map type [\"expression\"]) (map type [\"any\" \"*\"])]");
BUILTINS_TYPES["call"] = type_40;
auto type_41 = new LispVar;
*type_41 = parse_and_evaluate("[(map type [\"expression\"])]");
BUILTINS_TYPES["closure"] = type_41;
auto type_42 = new LispVar;
*type_42 = parse_and_evaluate("[(map type [\"string\"]) (map type [\"string\"])]");
BUILTINS_TYPES["match"] = type_42;
