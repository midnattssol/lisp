...
*type_13 = parse_and_evaluate("[(map type [\"int\"]) (map type [\"list\"])]");
*type_14 = parse_and_evaluate("[(map type [\"list\"]) (map type [\"any\"])]");
...
*type_19 = parse_and_evaluate("[(map type [\"booly\"]) (map type [\"string\" \"?\"])]");
*type_20 = parse_and_evaluate("[(map type [\"callable\"]) (map type [\"any\" \"*\"])]");
...
BUILTINS_TYPES["expression"] = type_1;
